				...
				Categories: []*tax.CategoryTotal{
					{
						...
						Surcharge: num.NewAmount(10400, 3),
					},
				},
				Sum: num.MakeAmount(83900, 3),
			},
		},
		{
						...
						Rates: []*tax.RateTotal{
							{
								Base:    num.MakeAmount(25000, 2),
								Percent: num.NewPercentage(210, 3),
								Amount:  num.MakeAmount(52500, 3),
							},
						},
						Amount: num.MakeAmount(52500, 3),
					},
				},
				Sum: num.MakeAmount(52500, 3),
			},
		},
		{
				...
				Categories: []*tax.CategoryTotal{
					{
						...
						Rates: []*tax.RateTotal{
							...
							},
							{
								...
								Base:    num.MakeAmount(15000, 2),
								Percent: num.NewPercentage(100, 3),
								Amount:  num.MakeAmount(15000, 3),
							},
						},
						Amount: num.MakeAmount(36000, 3),
					},
				},
				Sum: num.MakeAmount(36000, 3),
			},
		},
		{
