...
// Placeholder extension keys. The totals calculator carries Ext through
// untouched, so these stand in for real addon ext keys the fixtures need
// without coupling this core test to any addon package.
const (
	extKeyExempt   cbc.Key = "exempt-placeholder"
	extKeyRetained cbc.Key = "retained-placeholder"
	extKeyTaxRate  cbc.Key = "tax-rate-placeholder"
)
