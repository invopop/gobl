...
- `no`: Norwegian tax regime with VAT categories, mod-11 organisasjonsnummer validation, reverse-charge scenario injection, simplified invoice support, and credit note correction support.
