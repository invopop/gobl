...
- `regimes/se`: `IdentityKeyFSkatt` (`se-f-skatt`) identity key marking a Swedish supplier as approved for F-tax; normalizer fills the `Godkänd för F-skatt` boilerplate.
