...
- `dk-oioubl-v2`: re-added to the approved external addons list ([`github.com/invopop/gobl.dk.oioubl`](https://github.com/invopop/gobl.dk.oioubl), Danish OIOUBL 2.1). Previously removed in v0.502.1 as premature; re-added now that the module is stable.
