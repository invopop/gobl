...
### CUI/CIF Checksum Algorithm

Example calculation for CUI `18547290`:

```
Code: 1854729 (check digit: 0)
Padded: 001854729
Weights: [7,5,3,2,1,7,5,3,2]
Calculation:
  0×7 + 0×5 + 1×3 + 8×2 + 5×1 + 4×7 + 7×5 + 2×3 + 9×2
  = 0 + 0 + 3 + 16 + 5 + 28 + 35 + 6 + 18 = 111
  (111 × 10) mod 11 = 1110 mod 11 = 10
  Rule: If remainder is 10, check digit is 0
  Check digit matches: 0 ✓

```

### CNP Checksum Algorithm

Example calculation for CNP `5000101010003`:

```
Digits: 5 0 0 0 1 0 1 0 1 0 0 0 (first 12)
Weights: [2,7,9,1,4,6,3,5,8,2,7,9]
Calculation:
  5×2 + 0×7 + 0×9 + 0×1 + 1×4 + 0×6 + 1×3 + 0×5 + 1×8 + 0×2 + 0×7 + 0×9
  = 10 + 0 + 0 + 0 + 4 + 0 + 3 + 0 + 8 + 0 + 0 + 0 = 25
  25 mod 11 = 3
  Check digit matches: 3 ✓
...
- CUI/CIF validation with checksum verification (2-10 digits)
- CNP validation with checksum and format checks
- Invoice validation for all supported types
- Correction document validation (credit notes, debit notes, corrective invoices)
- Organization identity normalization (CUI and CNP)
- Historical VAT rate verification
