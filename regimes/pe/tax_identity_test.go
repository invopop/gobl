...
func TestValidateTaxIdentity(t *testing.T) {
	...
	tests := []struct {
		...
		// Real RUCs, verified against the SUNAT mod-11 algorithm.
		...
		{name: "valid non-domiciled (15)", code: "15000000016", valid: true},
		{name: "valid non-domiciled (16)", code: "16401234563", valid: true},
		{name: "valid non-domiciled (17)", code: "17401234560", valid: true},
