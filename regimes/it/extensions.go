...
var extensionKeys = []*cbc.KeyDefinition{
	...
	},
	{
		...
		Values: []*cbc.ValueDefinition{
			{Value: "RF01", Name: i18n.String{
				i18n.EN: "Ordinary",
				i18n.IT: "Regime Ordinario",
			}},
			{Value: "RF02", Name: i18n.String{
