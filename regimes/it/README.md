...
| TD28 | `standard`    | `self-billed`, `san-merino-paper`   | Purchases from San Marino with VAT (paper invoice)                                                                                                                                |
...
| N3.3 | `not-taxable+san-merino`                     | not taxable - transfers to San Marino                                                                                                                                                                                                                    |
