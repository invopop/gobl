...
func TestValidateAttachmentsEdgeCases(t *testing.T) {
	...
	t.Run("attachment with nil entry is skipped", func(t *testing.T) {
		attachments := []*org.Attachment{
			nil,
			{
				Description: "RIB",
	...
	t.Run("attachment with empty description is valid", func(t *testing.T) {
		attachments := []*org.Attachment{
			{
				Description: "",
			},
	...
	t.Run("attachment with whitespace-only description gets trimmed and fails", func(t *testing.T) {
		attachments := []*org.Attachment{
			{
				Description: "   ",
			},
