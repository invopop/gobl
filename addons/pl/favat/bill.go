	...
	return rules.For(new(bill.Invoice),
		...
		rules.Field("supplier",
			...
			rules.Field("addresses",
				rules.Assert("06", "supplier addresses are required", is.Present),
				rules.Assert("07", "supplier first address must have a country",
					is.Func("first address country", firstAddressHasCountry),
				),
				rules.Assert("08", "supplier first address must have a street",
		...
		rules.Assert("13", "missing exemption note",
