...
// Util methods influenced by the github.com/invopop/validation library.
...
// emptyValue checks if a value is empty or not.
...
func emptyValue(value interface{}) bool {
	...
	case reflect.Interface, reflect.Ptr:
		...
		return emptyValue(v.Elem().Interface())
	case reflect.Struct:
...
// normalizeValue converts a named type to its underlying primitive so that
// cross-type comparisons (e.g. Code("A") == "A") work correctly.
